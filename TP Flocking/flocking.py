...
# for i in range(2):
    ...
    for boid in boids:
        ...
        mouse.isMouse = True
        distance_mouse = boid.distance(mouse)
        ...
        see_shepard = distance_mouse < 250
        ...
        if boid.state == 'stand':
            if see_shepard:
                to_follow = {mouse}
                boid.state = 'follow_shepard'
            elif see_flock:
                to_follow = closeBoids
                boid.state = 'follow_flock'
            elif see_nothing:
                boid.state = 'stand'

        elif boid.state == 'follow_shepard':
            if see_shepard:
                to_follow = {mouse}
                boid.state = 'follow_shepard'
            elif see_flock:
        ...
        # print(boid.state)
        boid.moveCloser(to_follow)
        boid.moveWith(to_follow)
